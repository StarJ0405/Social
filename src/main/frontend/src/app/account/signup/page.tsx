        ...
        <main>
            <div className="flex justify-center items-center h-screen w-screen flex-col">
                <div className="w-[350px] h-[700px] border-black border flex flex-col items-center justify-center">
                    <Image src="/logo_big.png" width="200" height="100" alt="logo_big" />
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <label className="input input-bordered flex items-center gap-2 m-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" /></svg>
                            <input type="text" className="grow" id="phoneNumber" name="phoneNumber" placeholder="전화번호" value={values.phoneNumber} onChange={handleChange}/>
                        </label>
