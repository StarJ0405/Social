...
import { deleteAlarm, fetchUser, getAlarms, saveArticleTempImage, writeArticle } from '@/app/Global/API/UserAPI';
            ...
            {status == 1 ?
                ...
                : status == 2 ?
                    <div className={'bg-base-100 h-screen border-r-2 flex flex-col justify-start w-full'}>
                        ...
                        <div className='flex flex-col self-center items-center w-[350px] text-sm text-center'>
                            {alarms.length == 0 ?
                                <>
